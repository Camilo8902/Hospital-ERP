...
import type { VitalSigns, Diagnosis, ICD10Code } from '@/lib/actions/clinical-records';
        ...
        <div className="card">
          ...
          {expandedSections.chiefComplaint && (
            <div className="card-body space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Duración del síntoma</label>
                <input
                  type="text"
                  value={formData.chief_complaint_duration}
                  onChange={(e) => setFormData(prev => ({ ...prev, chief_complaint_duration: e.target.value }))}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Historia de la enfermedad actual</label>
                <textarea
